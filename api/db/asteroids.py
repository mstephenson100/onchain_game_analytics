...
def managedAsteroids(parameter1, parameter2):

    managed_asteroids = None
    con = pymysql.connect("127.0.0.1", db_user, db_password, db)
    managed_asteroids = getManagedAsteroids(con, parameter1, parameter2)
    con.close()
    return managed_asteroids
